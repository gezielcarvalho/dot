...
<head>
	...
	<meta name="Version" content="<?php echo $AppUI ? @$AppUI->getVersion() : 'Unknown';?>" />
...
<tr>
	<td align="right" nowrap><?php echo $AppUI ? $AppUI->_('Username') : 'Username';?>:</td>
	<td align="left" nowrap><input type="text" size="25" maxlength="255" name="username" class="text" /></td>
</tr>
<tr>
	<td align="right" nowrap><?php echo $AppUI ? $AppUI->_('Password') : 'Password';?>:</td>
...
<tr>
	...
	<td align="right" valign="bottom" nowrap><input type="submit" name="login" value="<?php echo $AppUI ? $AppUI->_('login') : 'login';?>" class="button" /></td>
</tr>
<tr>
	<td colspan="2"><a href="#" onclick="f=document.loginform;f.lostpass.value=1;f.submit();"><?php echo $AppUI ? $AppUI->_('forgotPassword') : 'forgotPassword';?></a></td>
</tr>
</table>
<?php if ($AppUI && @$AppUI->getVersion()) { ?>
<div align="center">
