...
<head>
	...
	<meta name="Version" content="<?php echo (isset($AppUI) && is_object($AppUI) && method_exists($AppUI,'getVersion')) ? htmlspecialchars($AppUI->getVersion(), ENT_QUOTES, 'UTF-8') : '';?>" />
...
<tr>
	<td align="right" nowrap><?php echo (isset($AppUI) && is_object($AppUI)) ? $AppUI->_('Username') : 'Username';?>:</td>
	<td align="left" nowrap><input type="text" size="25" maxlength="255" name="username" class="text" /></td>
</tr>
<tr>
	<td align="right" nowrap><?php echo (isset($AppUI) && is_object($AppUI)) ? $AppUI->_('Password') : 'Password';?>:</td>
...
<tr>
	...
	<td align="right" valign="bottom" nowrap><input type="submit" name="login" value="<?php echo (isset($AppUI) && is_object($AppUI)) ? $AppUI->_('login') : 'Login';?>" class="button" /></td>
</tr>
<tr>
	<td colspan="2"><a href="#" onclick="f=document.loginform;f.lostpass.value=1;f.submit();"><?php echo (isset($AppUI) && is_object($AppUI)) ? $AppUI->_('forgotPassword') : 'Forgot Password';?></a></td>
</tr>
</table>
<?php if (isset($AppUI) && is_object($AppUI) && method_exists($AppUI,'getVersion') && $AppUI->getVersion()) { ?>
<div align="center">
	<span style="font-size:7pt">Version <?php echo htmlspecialchars($AppUI->getVersion(), ENT_QUOTES, 'UTF-8'); ?></span>
</div>
<?php } ?>
</form>
<div align="center">
...
<center><?php echo "* ".((isset($AppUI) && is_object($AppUI)) ? $AppUI->_("You must have cookies enabled in your browser") : "You must have cookies enabled in your browser"); ?></center>
</body>
</html>
